...
const stakeId = "0x73a6cd37615a2d64777643851a06e0e2bab14e46cec96b9e3c14e80b14a210e1";
const delegatorAccount = "0x0e30610a83ffbbe157231e869ad6716b816d633d9c58e22b7100a66002df0afd";
const API_KEY = process.env.API_KEY // Replace with your actual API key

async function generateUnStakePayload(stakeId: string, delegatorAccount: string) {
    const API_URL = 'https://api.figment.io/sui/withdraw';
...
async function main() {
    try {
        ...
        let response = await generateUnStakePayload(stakeId, delegatorAccount);
