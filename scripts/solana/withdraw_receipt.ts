...
async function generateWithdrawalPayload(stakeAccount: string, recipient_account: string, withdrawAmount: number) {
...
async function main() {
    try {
        ...
        let response = await generateWithdrawalPayload(stakeAccount, fundingAccount, balance);
